  ...
  return (
    <section id="contact" className="py-24 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        <div className="absolute top-40 right-10 w-96 h-96 bg-indigo-200 rounded-full mix-blend-multiply opacity-15 animate-blob animation-delay-4000"></div>
        <div className="absolute bottom-20 left-20 w-80 h-80 bg-pink-200 rounded-full mix-blend-multiply opacity-15 animate-blob"></div>
        <div className="absolute top-1/3 left-1/3 w-60 h-60 bg-purple-100 rounded-full mix-blend-multiply opacity-10 animate-blob animation-delay-2000"></div>
      </div>
